				...
				<div class="table-responsive">
					<table class="table table-bordered" id="table">
						<tr>
							...
							<th>Body</th>
							<th>Created At</th>
							<th class="text-center"><a href="" class="create-modal btn btn-success btn-sm"><i class="glyphicon glyphicon-plus"></i></a></th>
						</tr>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="submit" class="btn btn-warning btn-sm" id="add">
							<span class="glyphicon glyphicon-plus">Save Post</span>
						</button>

						<button type="button" class="btn btn-warning btn-sm" data-dismiss="modal">
							<span class="glyphicon glyphicon-remobe">Close</span>
						</button>
					</div>
				</div>
			</div>
